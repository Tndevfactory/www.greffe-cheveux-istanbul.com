...
\t\$(\"#page-header5 .heading\").lettering(); 
\t\$(\".sub\").lettering(); 
\t
\t// \t gsap animation
\tgsap.from(\"#page-header5 .heading span\", {
...
\t});
\t
\tgsap.from(\"#page-header5 .sub span\", {
\t\tduration: 1,
\t\tx: -100,
\t\topacity: 0,
\t\trotation: 180,
...
\t            text-transform: uppercase;
      ...
      #page-header5 .heading span,
       #page-header5 .sub span {
          display: inline-block;
        }

      #page-header5 .blockVid{
            position: relative;
        ...
        #page-header5  .blockVid .caption {
            position: relative;
            z-index: 2;
          }

        #page-header5 .blockVid .overlay {
            position: absolute;
            top: 0;
            left: 0;
            height: 100%;
...
\t});
  ...
  </script>", "/components/qui_somme_nous/page_header.twig", "/var/www/tndevfactory/public_html/touchlink/www.greffe-cheveux-istanbul.com/app/views/components/qui_somme_nous/page_header.twig");
    }
}
