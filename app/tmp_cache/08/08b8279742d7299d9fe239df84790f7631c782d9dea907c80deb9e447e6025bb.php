                      ...
                      <div class=\"caption h-100\">
                        <div class=\"d-flex h-100 text-center align-items-center\">
                          <div class=\"w-100 text-white\">
                              <h1 class=\"heading\">Greffe-Sourcils</h1>
                              <hr class=\"hr\">
...
\t\$(\"#page-header2 .heading\").lettering(); 
\t\$(\".sub\").lettering(); 
\t
\t// \t gsap animation
\tgsap.from(\"#page-header2 .heading span\", {
...
\t});
\t
\tgsap.from(\"#page-header2 .sub span\", {
\t\tduration: 1,
\t\tx: -100,
\t\topacity: 0,
\t\trotation: 180,
...
\t            text-transform: uppercase;
      ...
      #page-header2 .heading span,
       #page-header2 .sub span {
          display: inline-block;
        }

      #page-header2 .blockVid{
            position: relative;
        ...
        #page-header2  .blockVid .caption {
            position: relative;
            z-index: 2;
          }

        #page-header2 .blockVid .overlay {
            position: absolute;
            top: 0;
            left: 0;
            height: 100%;
...
";
    ...
    {
        return array (  109 => 3,  44 => 129,  42 => 3,  38 => 1,);
    }
...
\t});
  ...
  </script>", "/components/greffe_sourcils/page_header.twig", "/var/www/tndevfactory/public_html/touchlink/www.greffe-cheveux-istanbul.com/app/views/components/greffe_sourcils/page_header.twig");
    }
}
