                      ...
                      <div class=\"caption h-100\">
                        <div class=\"d-flex h-100 text-center align-items-center\">
                          <div class=\"w-100 text-white\">
                              <h1 class=\"heading\">Greffe-Barbe</h1>
                              <hr class=\"hr\">
...
\t\$(\"#page-header3 .heading\").lettering(); 
\t\$(\".sub\").lettering(); 
\t
\t// \t gsap animation
\tgsap.from(\"#page-header3 .heading span\", {
...
\t});
\t
\tgsap.from(\"#page-header3 .sub span\", {
\t\tduration: 1,
\t\tx: -100,
\t\topacity: 0,
\t\trotation: 180,
...
\t            text-transform: uppercase;
      ...
      #page-header3 .heading span,
       #page-header3 .sub span {
          display: inline-block;
        }

      #page-header3 .blockVid{
            position: relative;
        ...
        #page-header3  .blockVid .caption {
            position: relative;
            z-index: 2;
          }

        #page-header3 .blockVid .overlay {
            position: absolute;
            top: 0;
            left: 0;
            height: 100%;
...
\t});
  ...
  </script>", "/components/greffe_barbe/page_header.twig", "/var/www/tndevfactory/public_html/touchlink/www.greffe-cheveux-istanbul.com/app/views/components/greffe_barbe/page_header.twig");
    }
}
